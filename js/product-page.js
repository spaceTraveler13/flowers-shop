...
let dataBoquetsArray = [
    ...
    {
        data: 'custom-genteltones',
        name: 'Букет сборный в нежных тонах',
        desc: 'Альстрометрия - 3шт.<br/>Лимониум - 3т.<br/>Роза кустовая - 3шт.<br/>Хризантема Сантини - 3шт.<br/>Эвкалипт - 5шт.<br/>Роза - 5шт.<br/>Эустома - 4шт.<br/>Диантус - 3шт.<br/>Лента атласная - 1шт.<br/>Упаковка дизайнерская- 2шт.<br/>',
        price: 7950,
        img: 'img/custom-gentletones.webp'
    },
    {
        data: 'warm-friendship',
        name: 'Букет Теплая дружба',
        desc: 'Гипсофила - 2шт.<br/>Хризантема ромашковая кустовая - 7шт.<br/>Лента атласная - 1шт.<br/>Упаковка дизайнерская- 2шт.<br/>',
        price: 3100,
        img: 'img/warm-friendship.webp'
    },
    {
        data: 'gerberas',
        name: 'Букет с герберами',
        desc: 'Гербера - 7шт.<br/>Роза - 15шт.<br/>Гиперикум - 7шт.<br/>Салал - 10шт.<br/>Лента атласная - 1шт.<br/>',
        price: 6170,
        img: 'img/gerberas.webp'
    },
    {
        data: 'sky',
        name: 'Букет Небо',
        desc: 'Хризантема кустовая - 13шт.<br/>Лента атласная - 1шт.<br/>Упаковка дизайнерская- 1шт.<br/>',
        price: 4250,
        img: 'img/sky.webp'
    },
    {
        data: 'pink-malina',
        name: 'Букет Розово-малиновый',
        desc: 'Роза - 7шт.<br/>Эустома - 3шт.<br/>Хризантема Момоко - 3шт.<br/>Диантус - 4шт.<br/>Альстрометрия - 3шт.<br/>Лента атласная - 1шт.<br/>Упаковка дизайнерская- 1шт.<br/>',
        price: 5700,
        img: 'img/pink-malina.webp'
    },
    {
        data: 'chris-tanacetum',
        name: 'Хризантема с танацетумом',
        desc: 'Хризантема ромашка - 5шт.<br/>Танацетум - 4шт.<br/>Лента атласная - 1шт.<br/>Упаковка дизайнерская- 1шт.<br/>',
        price: 2300,
        img: 'img/chris-tanacetum.webp'
    },
]
