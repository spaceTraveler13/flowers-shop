...
let dataBoquetsArray = [
    ...
    },
    {
        data: 'custom5',
        name: 'Букет Сборный',
        desc: 'Эустома - 3шт.<br/>Хр.Балтика - 3 шт.<br/>Гв.ст - 3 шт.<br/>Роза Пинк Мондеаль - 3 шт.<br/>Озотамнус - 1 шт.<br/>Упаковка: Пшеница - 4 шт.<br/>Полынь - 2 шт.<br/>Плёнка + лента',
        price: 3850,
